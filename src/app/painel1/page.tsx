        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            <h1 className="text-xl font-bold text-gray-900">
              Painel 1: Situação Meteorológica
            </h1>
            <CapitalSelector
          ...
          <p className="text-sm text-gray-500">
            Visão integrada e comparativa das condições em tempo real - {capitalInfo.name}, {capitalInfo.stateCode}
          </p>
        </div>
          ...
          <div className="flex-1 grid grid-cols-12 gap-4 min-h-0">
            ...
            <div className="col-span-5 bg-white rounded-lg shadow-sm border overflow-hidden flex flex-col">
              <div className="p-3 border-b bg-gray-50">
                ...
                <p className="text-xs text-gray-500">{weatherData.length} estações monitoradas</p>
              </div>
            ...
            <div className="col-span-4 flex flex-col gap-4">
              ...
              {selectedWeather && (
                <div className="bg-white rounded-lg shadow-sm border p-4">
                  ...
                  <p className="text-xs text-gray-500 mb-3">
                    Última atualização: {formatTimeAgo(selectedWeather.timestamp)}
                  </p>
              ...
              {/* Acumulados */}
              <div className="bg-white rounded-lg shadow-sm border p-4">
                <h3 className="font-semibold text-gray-900 mb-3">Acumulados Médios</h3>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-4">
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Máxima 1h: {stats.maxRain1h.toFixed(1)} mm | {alertCount} estações em alerta
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-4">
                ...
                <div className="space-y-2">
                  {weatherData.filter(w => w.alertLevel !== 'normal').length === 0 ? (
                    ...
                    weatherData.filter(w => w.alertLevel !== 'normal').slice(0, 3).map(station => (
                      <div key={station.stationId} className="flex items-center gap-2 p-2 bg-gray-50 rounded">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-gray-500">{station.rain.last1h}mm/1h</p>
                        </div>
                      </div>
                    ))
                  )}
